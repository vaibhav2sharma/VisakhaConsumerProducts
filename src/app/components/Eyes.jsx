...
const Eyes = () => {
  ...
  return (
    ...
    <div className="bg-white h-[80px] w-[80px]  md:h-[200px]  md:w-[200px] absolute md:top-[300px] top-[70px] left-[20%] md:left-[35%] rounded-[50%]  ">
    ...
    <div className="bg-white h-[80px] w-[80px] md:h-[200px]  md:w-[200px] absolute md:top-[300px] top-[70px] right-[20%] md:right-[35%] rounded-[50%]  ">
