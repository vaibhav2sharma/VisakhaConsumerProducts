...
const LandingText = () => {
  return (
    <div data-scroll data-scroll-speed="-0.5"  className='h-[100vh] md:h-[90vh] w-full bg-[#F1F1F1] flex flex-col  gap-[50px] md:gap-[0px] md:flex-row md:items-end justify-evenly '>
