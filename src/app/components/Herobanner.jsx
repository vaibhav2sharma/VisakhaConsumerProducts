...
const Herobanner = () => {
  return (
   <>
    <section className=' w-full h-[100vh] flex  relative flex-col  sm:flex-row mb-5 '>

        <div className='bg-white w-full md:w-[50%]     text-center justify-center items-center flex flex-col h-[100%]   ' >

          <h1 className='text-black   text-[30px] md:text-[55px]  font-medium font-sans hover:text-sky-400 duration-500  z-10'>Visakha Consumer Products </h1>
